...
const Form = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center  bg-cover bg-center bg-no-repeat">
    <StyledWrapper>
      <label htmlFor="file" className="custum-file-upload">
        ...
        <div className="text" >
          <span onClick={upload} >Click to upload image</span>
        </div>
        <input id="file" type="file" onChange={upload} />
        <div className="preview">
            {file && 
            <img src={file} alt="preview" style={{ maxWidth: '100%', maxHeight: '100%' }} className="object-fit" />
            }
        </div>
      </label>
    </StyledWrapper>
